...
8. **{req.category}考生的选科是{req.subject_combo}。如果类别是"历史类"，所有推荐的专业必须是不限选科或限历史类的纯文科专业（法学、汉语言文学、会计学、师范类、外语、管理学、新闻传播、经济学等），绝对不要推荐任何需要物理/化学/生物选科的理工科专业。summary中也不得提及理工科学校或专业。**
